  ...
  return (
    <section className="py-24 px-6 text-center">
      <div className="reveal max-w-3xl mx-auto">
        ...
        <a href="mailto:your@email.com" className="group relative px-12 py-6 bg-slate-950 dark:bg-white text-white dark:text-slate-950 font-black rounded-full transition-all hover:scale-105 active:scale-95 overflow-hidden shadow-2xl">
