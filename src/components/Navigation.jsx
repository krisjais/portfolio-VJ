...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 glass border-b border-slate-200 py-4 px-6 md:px-20 flex justify-between items-center backdrop-blur-md">
        ...
        <a href="#home" className="flex items-center gap-3 group cursor-pointer">
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 bg-green-500/10 rounded-full border border-green-500/20">
            ...
            <span className="text-[9px] font-black text-green-600 uppercase tracking-tighter">Available</span>
          </div>
        </a>
      ...
      {/* Mobile Menu */}
      <div className={`fixed top-[73px] right-0 w-64 h-[calc(100vh-73px)] bg-white border-l border-slate-200 z-40 transform transition-transform duration-300 ease-in-out lg:hidden ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
